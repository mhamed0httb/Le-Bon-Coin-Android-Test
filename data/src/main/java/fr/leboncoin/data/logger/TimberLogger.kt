package fr.leboncoin.data.logger
...
@Singleton
class TimberLogger @Inject constructor() : Logger, LoggerConfiguration {

    override fun setup(isDebug: Boolean) {
        if (isDebug) {
            Timber.plant(Timber.DebugTree())
        }
        GlobalLogger.init(this)
    }
